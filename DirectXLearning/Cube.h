...
{
public:
	static IndexedTriangleList Make(std::optional<dxLearning::VertexLayout> layout = {}) {
		using namespace dxLearning;
		using Type = dxLearning::VertexLayout::ElementType;

		if (!layout) {
			layout = dxLearning::VertexLayout{};
	...
	static IndexedTriangleList MakeIndependent(dxLearning::VertexLayout layout)
	{
		using namespace dxLearning;
		using Type = dxLearning::VertexLayout::ElementType;
