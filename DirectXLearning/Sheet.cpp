...
Sheet::Sheet(Graphics& gfx, 
	...
	if (!IsStaticInitialized()) {
		...
		auto vertexShader = std::make_unique<VertexShader>(gfx, L"TextureVS.cso");
		auto vertexShaderBC = vertexShader->GetBytecode();
		...
		AddStaticBind(std::make_unique<InputLayout>(gfx, ied, vertexShaderBC));
