...
public:
	...
	IndexedTriangleList(dxLearning::VertexBuffer verts_in, std::vector<unsigned short> indices_in)
	...
	void Transform(DirectX::FXMMATRIX matrix) {
		using Elements = dxLearning::VertexLayout::ElementType;
...
public:
	dxLearning::VertexBuffer vertices;
