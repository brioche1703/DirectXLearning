...
{
public:
	static IndexedTriangleList MakeTesselated(dxLearning::VertexLayout layout, int latDiv, int longDiv)
	{
	...
	static IndexedTriangleList Make(std::optional<dxLearning::VertexLayout> layout = std::nullopt)
	{
		using Element = dxLearning::VertexLayout::ElementType;
		if (!layout) {
			layout = dxLearning::VertexLayout{}.Append(Element::Position3D);
		}
